...
<html>
  ...
  <body>
    <pre>
(<span class="keyword">defun</span> <span class="function-name">lispy-out-forward</span> (arg)
  <span class="doc">"Move outside list forwards ARG times.
Return nil on failure, t otherwise."</span>
  (interactive <span class="string">"p"</span>)
  (<span class="keyword">if</span> (region-active-p)
      <span class="region">(lispy-mark-right arg)</span>
    (lispy--out-forward arg)))</pre>
  </body>
</html>
#+END_HTML
#+HTML: </td><td>
...
Return nil on failure, t otherwise."</span>
  (interactive <span class="string">"p"</span>)
  <span class="region">(</span><span class="keyword"><span class="region">if</span></span><span class="region"> (region-active-p)
      (lispy-mark-right arg)
    (lispy--out-forward arg))</span>)</pre>
  </body>
</html>
#+END_HTML
...
Calls [[#lispy-ace-symbol][=lispy-ace-symbol=]], in addition deleting only the selected
symbol.
-----
