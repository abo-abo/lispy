...
| xf  | [[id:0a7420dc-86f8-4012-88ee-2f4a10cdb012][lispy-flatten]]                 |
|-----+-------------------------------|
...
Call [[id:80cb6d3d-f3fe-4c0f-9eaf-e098679aada4][=lispy-pair=]] specialized with =()=.
-----
...
** =lispy-flatten=
:PROPERTIES:
:ID:       0a7420dc-86f8-4012-88ee-2f4a10cdb012
:END:

Bound to ~xf~.

Inline current function call, i.e. replace it with function body.
The function should be stored with [[id:3ddf7d0f-83c9-4880-b170-ce36c549c537][=lispy-store-region-and-buffer=]].
-----
